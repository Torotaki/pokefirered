...
#define STATUS3_SLASH_PREPARED          (1 << 21)
#define STATUS3_GROWN                   (1 << 22)
...
#define B_WEATHER_HAIL_PERMANENT      (1 << 1)
#define B_WEATHER_AROMA               (1 << 2)
#define B_WEATHER_FOG                 (1 << 3)
#define B_WEATHER_SANDSTORM           (1 << 4)
...
#define B_WEATHER_ANY                 (B_WEATHER_RAIN | B_WEATHER_SANDSTORM | B_WEATHER_SUN | B_WEATHER_HAIL | B_WEATHER_AROMA | B_WEATHER_FOG)
...
#define B_TERRAIN_EFFECT_SHARP_ROCKS  (1 << 3)
#define B_TERRAIN_EFFECT_UNDEFINED4   (1 << 4)
#define B_TERRAIN_EFFECT_UNDEFINED5   (1 << 5)
#define B_TERRAIN_EFFECT_UNDEFINED6   (1 << 6)
#define B_TERRAIN_EFFECT_UNDEFINED7   (1 << 7)
...
#define BATTLE_TERRAIN_SHARP_ROCKS 22
