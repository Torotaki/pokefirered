...
#define IS_MOVE_STATUS(move)(move.category == CATEGORY_STATUS)
#define IS_MOVE_PHYSICAL(move)(move.category == CATEGORY_PHYSICAL)
#define IS_MOVE_SPECIAL(move)(move.category == CATEGORY_SPECIAL)
