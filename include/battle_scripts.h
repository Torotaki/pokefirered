...
extern const u8 BattleScript_RagingRocksContinues[];
extern const u8 BattleScript_RagingRocksDoDamage[];
extern const u8 BattleScript_OverworldWeatherStarts[];
extern const u8 BattleScript_SideStatusWoreOff[];
extern const u8 BattleScript_SafeguardProtected[];
extern const u8 BattleScript_SafeguardEnds[];
extern const u8 BattleScript_TrickMirrorEnds[];
...
extern const u8 BattleScript_SleepTranceSetUp[];
...
extern const u8 BattleScript_MoveUsedDistracted[];
extern const u8 BattleScript_MoveUsedStuckAirborne[];
extern const u8 BattleScript_MoveUsedStuckUnderneath[];
...
extern const u8 BattleScript_NonConsumedItemStatRaiseEnd2[];
...
extern const u8 BattleScript_DistractActivates[];
extern const u8 BattleScript_DistractActivatesEnd3[];
