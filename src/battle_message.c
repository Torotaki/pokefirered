...
static const u8 sText_TerrainCantEscape[] = _("{B_ATK_NAME_WITH_PREFIX} is prevented from\nescaping by the SAND TRAP!\p");
...
static const u8 sText_PkmnRaisedStat[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nraised its {B_BUFF1}!");
static const u8 sText_PkmnRaisedTwoStats[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nraised its {B_BUFF1} and {B_BUFF2}!");
...
static const u8 sText_PkmnsXLostHPInSun[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY}\ndries out in the sun!");
...
const u8 gText_TerrainPreventsSwitching[] = _("SAND TRAP prevents {B_COPY_VAR_1}\nfrom switching!\p");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT - BATTLESTRINGS_TABLE_START] = {
    ...
    [STRINGID_PKMNRAISEDSTAT - BATTLESTRINGS_TABLE_START]               = sText_PkmnRaisedStat,
    ...
    [STRINGID_PKMNSXSUMMONEDHAILSTORM - BATTLESTRINGS_TABLE_START]       = sText_PkmnsXSummonedHailstorm,
...
const u16 gNoEscapeStringIds[] =
{
    ...
    [B_MSG_TERRAIN_CANT_ESCAPE]  = STRINGID_TERRAIN_CANT_ESCAPE
};
...
const u16 gProtectLikeUsedStringIds[] =
{
    ...
    [B_MSG_DUG_UNDERGROUND]  = STRINGID_PKMNDUGHOLE
};
...
const u16 gEntryStatChangeMonStringIds[] =
{
