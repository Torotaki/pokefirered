...
const u8 gText_PkmnFellAsleep[] = _("{STR_VAR_1} fell asleep.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_NotEnoughPp[] = _("Not enough PP‥");
...
const u8 gText_RevivePokemon[] = _("Revive a POKéMON.");
...
const u8 gText_CategoryStatus[] = _("STAT");
const u8 gText_CategoryPhysical[] = _("PHYS");
const u8 gText_CategorySpecial[] = _("SPEC");
