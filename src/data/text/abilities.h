...
static const u8 sLiquidOozeDescription[] = _("Draining hurts foe. BLACK SLUDGE heals.");
...
static const u8 sShellArmorDescription[] = _("Blocks critical hits and resets stats.");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_ROUGH_SKIN] = _("SPIKE SHIELD"),
    ...
    [ABILITY_SWIFT_SWIM] = _("RAIN RUSH"),
