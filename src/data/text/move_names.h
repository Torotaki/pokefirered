const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] = {
    ...
    [MOVE_CEMETERY]      = _("CEMETERY"),
    [MOVE_COUNTERPUNCH]  = _("COUNTERPUNCH"),
    [MOVE_COUNTERPUNCH_HIT] = _("CNTPNCH HIT"),
    [MOVE_DRAGON_HUNT]   = _("DRAGON HUNT"),
