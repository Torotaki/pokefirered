const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_GOLBAT]     = {{EVO_TRADE, 0, SPECIES_GOLBAT}},
    [SPECIES_ODDISH]     = {{EVO_LEVEL, 21, SPECIES_GLOOM}},
    [SPECIES_GLOOM]      = {{EVO_LEVEL, 35, SPECIES_VILEPLUME},
    ...
    [SPECIES_GROWLITHE]  = {{EVO_LEVEL, 30, SPECIES_ARCANINE}},
    ...
    [SPECIES_MACHOP]     = {{EVO_LEVEL, 26, SPECIES_MACHOKE}},
    ...
    [SPECIES_SHELLDER]   = {{EVO_LEVEL, 35, SPECIES_CLOYSTER}},
    ...
    [SPECIES_EXEGGCUTE]  = {{EVO_LEVEL, 38, SPECIES_EXEGGUTOR}},
    ...
    [SPECIES_STARYU]     = {{EVO_LEVEL, 22, SPECIES_STARMIE}},
