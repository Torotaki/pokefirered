const struct BattleMove gBattleMoves[MOVES_COUNT] =
{
    ...
    [MOVE_SOLAR_BEAM] =
    {
        .effect = EFFECT_SLEEPING_SOLAR_BEAM,
        .power = 90,
        .type = TYPE_GRASS,
        .accuracy = 100,
        .pp = 10,
    ...
    [MOVE_MACH_PUNCH] =
    {
        ...
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .flags = FLAG_MAKES_CONTACT | FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_PUNCH,
        .category = CATEGORY_PHYSICAL,
    },
    ...
    [MOVE_WAKE_UP_SLAP] =
    {
        ...
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .flags = FLAG_MAKES_CONTACT | FLAG_PROTECT_AFFECTED | FLAG_MAKES_CONTACT | FLAG_MIRROR_MOVE_AFFECTED,
        .category = CATEGORY_PHYSICAL,
    },
    ...
    [MOVE_SKY_TOSS] =
    {
        .effect = EFFECT_LAUNCH_AIRBORNE_HIT,
        .power = 70,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
        .pp = 25,
    ...
    [MOVE_CEMETERY] =
    {
        .effect = EFFECT_FOG_AND_SHARP_ROCKS,
        .power = 0,
        .type = TYPE_GHOST,
        .accuracy = 100,
        .pp = 10,
