...
const u8 gMoveDescription_Roar[] = _("A horribly loud\nshout. Can be used\nwhile asleep and\nwakes all POKéMON.");
...
const u8 gMoveDescription_Growth[] = _("The user grows to\ndouble their max\nHP. Cannot be\nstacked or passed.");
...
const u8 gMoveDescription_ShellBash[] = _("The user raises its\nDEFENSE, then attacks.");
...
const u8 gMoveDescription_Sharpen[] = _("The user prepares\nits blade for a\npowerful CUT or\nSLASH next turn.");
...
const u8 gMoveDescription_MachPunch[] = _("A fast punch. It\nstrikes first every\nsecond time it is\nused in a row.");
...
const u8 gMoveDescription_SludgeBomb[] = _("Sludge is hurled.\nPoisons the target\nand gives them\nBLACK SLUDGE.");
const u8 gMoveDescription_MudSlap[] = _("Mud is hurled in\nthe foe's face to\ninflict damage and\nlower its accuracy.");
const u8 gMoveDescription_AquaJet[] = _("The foe is struck\nwith a lot of water\nor Ice in snowy terrain.");
...
const u8 gMoveDescription_LockOn[] = _("Make the next move\nsure to hit and\nprevents escape\nfor one turn.");
...
const u8 gMoveDescription_SweetScent[] = _("Fills the air with a\nsweet aroma.\nIt also attracts\nwild POKéMON.");
...
const u8 gMoveDescription_Facade[] = _("An attack boosted\nif user has burn,\npoison, freeze or\nparalysis.");
...
const u8 gMoveDescription_Ingrain[] = _("Lay roots to heal\nHP every turn.\nPrevents ELECTRIC\nand switching out.");
...
const u8 gMoveDescription_Eruption[] = _("Spreads a mass of\nscalding smoke and\nash. Creates a\nthick fog.");
...
const u8 gMoveDescription_HyperVoice[] = _("A horribly loud\nshout. Can be used\nwhile asleep and\nwakes all POKéMON.");
...
const u8 gMoveDescription_RockTomb[] = _("Surrounds the foe\nwith rocks. It sets\nSHARP ROCKS and\nlowers foe's SPEED.");
...
const u8 gMoveDescription_SheerCold[] = _("Sharply cools down\nthe area. Creates\nsnow and freezes\nthe foe.");
...
const u8 gMoveDescription_GhostWalk[] = _("Slowly switches\nout, passing along\nany stat changes\nto the new battler.");
...
const u8 gMoveDescription_Duck[] = _("Avoids an attack by\ngoing underground.\nIt may fail if used\nin succession.");
...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT - 1] = {
    ...
    [MOVE_SHELL_BASH    - 1] = gMoveDescription_ShellBash,
    ...
    [MOVE_TAKE_AIM      - 1] = gMoveDescription_MindReader,
    ...
    [MOVE_AQUAJET       - 1] = gMoveDescription_AquaJet,
    ...
    [MOVE_GHOST_WALK    - 1] = gMoveDescription_GhostWalk,
